...
export default defineSchema({
  ...
  // ============================================================
  // PHASE 6A: NEW TABLES (Blog, Support, Vendors, Settings)
  // ============================================================

  // ============ 35. BLOG POSTS (Content Marketing) ============
  blogPosts: defineTable({
    ...
    author: v.optional(v.string()), // Author name for display
  ...
  // ============ 39. VENDORS (Multi-Vendor Marketplace) ============
  vendors: defineTable({
    userId: v.id("users"),
    businessName: v.string(),
    slug: v.string(),
